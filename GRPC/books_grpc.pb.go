...
type BookServiceClient interface {
	GetBooks(ctx context.Context, in *NoRequest, opts ...grpc.CallOption) (*BookListResponse, error)
	...
	UpdateBook(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookListResponse, error)
	DeleteBook(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookListResponse, error)
}
...
func (c *bookServiceClient) GetBooks(ctx context.Context, in *NoRequest, opts ...grpc.CallOption) (*BookListResponse, error) {
...
func (c *bookServiceClient) UpdateBook(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookListResponse, error) {
	out := new(BookListResponse)
...
func (c *bookServiceClient) DeleteBook(ctx context.Context, in *BookRequest, opts ...grpc.CallOption) (*BookListResponse, error) {
	out := new(BookListResponse)
...
type BookServiceServer interface {
	GetBooks(context.Context, *NoRequest) (*BookListResponse, error)
	GetBook(context.Context, *BookRequest) (*BookResponse, error)
	CreateBook(context.Context, *Book) (*BookResponse, error)
	UpdateBook(context.Context, *BookRequest) (*BookListResponse, error)
	DeleteBook(context.Context, *BookRequest) (*BookListResponse, error)
...
func (UnimplementedBookServiceServer) GetBooks(context.Context, *NoRequest) (*BookListResponse, error) {
...
func (UnimplementedBookServiceServer) UpdateBook(context.Context, *BookRequest) (*BookListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateBook not implemented")
}
func (UnimplementedBookServiceServer) DeleteBook(context.Context, *BookRequest) (*BookListResponse, error) {
...
func _BookService_GetBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).GetBooks(ctx, req.(*NoRequest))
	}
